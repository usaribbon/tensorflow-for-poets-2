 ...
 */
public class ImageClassifierOrigamiInception extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierOrigamiInception(Activity activity) throws IOException {
    super(activity);
  ...
  protected String getModelPath() {
    ...
    return "origami/graph.tflite";
  }

  @Override
  protected String getLabelPath() {
    return "origami/labels.txt";
  }
